...
UPDATED: Added Cloudflare endpoints for Render integration
"""
...
def execute_query_remote():
    ...
    This endpoint is called by Render to query your local SQL Server.
    """
    try:
        data = request.json
...
def execute_command_remote():
    ...
    This endpoint is called by Render to modify your local SQL Server.
    """
    try:
        data = request.json
        query = data.get('query')
        ...
        # Get the ID of the inserted row if applicable
        try:
...
def index():
    return jsonify({
        ...
        "endpoints": {
            ...
            "execute-query": "POST /execute-query (For Render)",
            "execute-command": "POST /execute-command (For Render)"
        }
    })
...
if __name__ == '__main__':
    ...
    print(f"\n🔗 Cloudflare Endpoints (for Render):")
    print(f"   📊 Query: POST /execute-query")
    print(f"   📝 Command: POST /execute-command")
